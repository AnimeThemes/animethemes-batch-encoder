...
class LoudnormFilter:
    ...
    def from_seek(cls, seek):
        ...
        loudnorm_output = (
            subprocess.check_output(loudnorm_args, stderr=subprocess.STDOUT)
            .decode("utf-8")
            .strip()
        )
    ...
    def get_normalization_filter(self) -> str:
        return (
            f"loudnorm=I=-16:LRA=20:TP=-1:dual_mono=true:linear=true:"
